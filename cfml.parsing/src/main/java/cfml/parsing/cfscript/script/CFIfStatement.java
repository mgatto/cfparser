...
public class CFIfStatement extends CFParsedStatement {
	...
	public CFIfStatement(org.antlr.v4.runtime.Token _t, CFExpression _cond, CFScriptStatement _then, CFScriptStatement _else) {
		super(_t);
		cond = _cond;
		thenStatement = _then;
		elseStatement = _else;
	...
	public List<CFScriptStatement> decomposeScript() {
		return ArrayBuilder.createCFScriptStatement(thenStatement, elseStatement);
	}
}
